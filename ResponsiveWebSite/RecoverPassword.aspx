<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecoverPassword.aspx.cs" Inherits="ResponsiveWebSite.RecoverPassword" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Reseet your Password</title>
     <!-- Bootstrap -->
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
           ...
           <div class="form-group">
               <asp:Label ID="lblMg" runat="server" CssClass="col-md-2 control-label" Font-Size="XX-Large" Font-Bold="True"></asp:Label>
               </div>

           <div class="form-group">
               <asp:Label ID="lblPassword" runat="server" CssClass="col-md-2 control-label" Text="New Password" Visible="False"></asp:Label>
               <div class="col-md-3">
                   <asp:TextBox ID="tbNewPass" runat="server" TextMode="Password" CssClass="form-control" Visible="False"></asp:TextBox>
           ...
           <div class="form-group">
               ...
               <div class="col-md-3">
                   <asp:TextBox ID="tbConfirmPass" runat="server" TextMode="Password" CssClass="form-control" Visible="False"></asp:TextBox>
