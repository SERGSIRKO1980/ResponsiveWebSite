<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="ResponsiveWebSite.AddProduct" %>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" CssClass="text-danger" runat="server" ErrorMessage="This Field is Required !" InitialValue="0" ControlToValidate="ddlBrands"></asp:RequiredFieldValidator>
                    </div>
                </div>
            <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" CssClass="text-danger" runat="server" ErrorMessage="This Field is Required !" InitialValue="0" ControlToValidate="ddlCategory"></asp:RequiredFieldValidator>
                    </div>
                </div>
            <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" CssClass="text-danger" runat="server" ErrorMessage="This Field is Required !" InitialValue="0" ControlToValidate="ddlSubCategory"></asp:RequiredFieldValidator>
                    </div>
                </div>
            <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" CssClass="text-danger" runat="server" ErrorMessage="This Field is Required !" InitialValue="0" ControlToValidate="ddlGender"></asp:RequiredFieldValidator>
                    </div>
                </div>
            <div class="form-group">
            ...
            <div class="form-group">
                    <asp:Label ID="Label11" runat="server" CssClass="col-md-2 control-label" Text="Upload Imege 1"></asp:Label>
                    <div class="col-md-3">
            ...
            <div class="form-group">
                    <asp:Label ID="Label12" runat="server" CssClass="col-md-2 control-label" Text="Upload Imege 2"></asp:Label>
                    <div class="col-md-3">
            ...
            <div class="form-group">
                    <asp:Label ID="Label13" runat="server" CssClass="col-md-2 control-label" Text="Upload Imege 3"></asp:Label>
                    <div class="col-md-3">
            ...
            <div class="form-group">
                    <asp:Label ID="Label14" runat="server" CssClass="col-md-2 control-label" Text="Upload Imege 4"></asp:Label>
                    <div class="col-md-3">
            ...
            <div class="form-group">
                    <asp:Label ID="Label15" runat="server" CssClass="col-md-2 control-label" Text="Upload Imege 5"></asp:Label>
                    <div class="col-md-3">
