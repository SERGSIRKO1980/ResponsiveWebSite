<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="ProductView.aspx.cs" Inherits="ResponsiveWebSite.ProductView" %>
...
<div style="padding-top:50px;">
  <div class="col-md-5">
    <div style="max-width:480px;" class="thumbnail">
        <div id="carusel-exemple-generic" class="carousel slide" data-ride="carusel">

      <!-- Indicators -->
            <ol class="carousel-indicators">
                <li data-target="#carusel-exemple-generic" data-slide-to="0" class="active"></li>
                <li data-target="#carusel-exemple-generic" data-slide-to="1"></li>
                <li data-target="#carusel-exemple-generic" data-slide-to="2"></li>
                <li data-target="#carusel-exemple-generic" data-slide-to="3"></li>
                <li data-target="#carusel-exemple-generic" data-slide-to="4"></li>
            </ol>
      ...
      <!--  Wrapper for slides -->
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item <%# GetActiveClass(Container.ItemIndex) %>">
                    <img width="480" src="Images/ProductImages/<%#Eval("PID") %>/<%#Eval("Name") %><%#Eval("Extention") %>" alt="<%#Eval("Name") %>" onerror="this.src='images/noimage.png'"/>
                </div>
      ...
      <!-- Controls -->
        <a class="left carousel-control" href="#carusel-exemple-generic" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="right carousel-control" href="#carusel-exemple-generic" role="button" data-slide="next">
    ...
    <div class="col-md-7">
      ...
      <div class="divDet1">
        ...
        <div  class="divDet1">
        <asp:Button ID="btnAddToCard" onClick="btnAddToCard_Click" CssClass="mainButton" runat="server" Text="ADD TO CARD" /> 
